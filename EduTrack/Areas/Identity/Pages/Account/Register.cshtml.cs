...
namespace EduTrack.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new User { UserName = Input.Email, Email = Input.Email, FullName = Input.FullName, RoleName = Input.RoleName};
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        var addRoleToUser = await _userManager.AddToRoleAsync(user, "Teacher");
                    }
